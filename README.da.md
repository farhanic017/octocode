...
brew install farhanic017/tap/octocode # macOS og Linux (anbefalet, altid up to date)
brew install octocode              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
OctoCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/farhanic017/octocode/releases) eller [octocode.ai/download](https://octocode.ai/download).
...
1. `$OCTOCODE_INSTALL_DIR` - Tilpasset installationsmappe
...
OctoCode har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://octocode.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af OctoCode, [**se vores docs**](https://octocode.ai/docs).

### Bidrag

Hvis du vil bidrage til OctoCode, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på OctoCode

Hvis du arbejder på et projekt der er relateret til OctoCode og bruger "octo" som en del af navnet; f.eks. "octocode-dashboard" eller "octocode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OctoCode-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/octocode) | [X.com](https://x.com/octocode)

...
export interface DialogSelectOption<T = any> {
  ...
  rowActions?: { checked: () => boolean; onTrigger: () => void }[]
}
      ...
      return (
        ...
        >
          ...
          <box
            ...
            backgroundColor={checked() ? theme.primary : RGBA.fromInts(0, 0, 0, 0)}
          >
            <text fg={checked() ? "#ffffff" : theme.textMuted}>
              {checked() ? "■" : "□"}
            </text>
          </box>
        </box>
                                ...
                                {(rowAction) => {
                                  ...
                                  return (
                                    <box
                                      ...
                                      height={1}
                                      borderStyle="rounded"
                                      borderColor={checked() ? theme.error : theme.textMuted}
                                      backgroundColor={checked() ? theme.error : RGBA.fromInts(0, 0, 0, 0)}
                                      flexShrink={0}
                                      onMouseUp={(e: { stopPropagation(): void }) => { e.stopPropagation(); rowAction.onTrigger() }}
                                    >
                                      <text fg={checked() ? "#ffffff" : theme.textMuted}>■</text>
                                    </box>
                                  )
                                }}
                              </For>

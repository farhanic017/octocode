          ...
          >
            ...
            <box flexDirection="row" gap={2} marginTop={1}>
              <box
                ...
                alignItems="center"
                height={1}
                onMouseOver={() => setHoveredCommand("extension")}
                onMouseOut={() => setHoveredCommand(null)}
                onMouseUp={async () => {
              ...
              >
                <text fg={hoveredCommand() === "extension" ? C.pink : C.muted} attributes={TextAttributes.BOLD} wrapMode="none">@</text>
                <text fg={hoveredCommand() === "extension" ? C.pink : C.muted} wrapMode="none">
                  Extension
                </text>
              </box>
              <MemoryButton />

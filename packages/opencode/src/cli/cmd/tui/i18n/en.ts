export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using OctoCode, you agree to our ",
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at octocode.ai",
  ...
  "tui.tips.config_files":
    "Create {highlight}octocode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/octocode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "OctoCode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.octocode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.octocode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "OctoCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "OctoCode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.octocode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.octocode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent OctoCode from reading sensitive files",
  "tui.tips.run": "Use {highlight}octo run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}octo --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}octo run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}octo serve{/highlight} for headless API access to OctoCode",
  "tui.tips.attach_server": "Use {highlight}octo run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}octo upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}octo auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}octo agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}octo github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.octocode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}octo debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with OctoCode for curated, tested models",
  ...
  "tui.model.octo_auto.name": "MiMo Auto (MiMo-V2.5, limited-time free)",
  ...
  "tui.toast.update_available.success": "Successfully updated to OctoCode v{{version}}. Please restart the application.",
  ...
  "tui.dialog.login.octo_free": "MiMo Auto (free)",
  "tui.dialog.login.octo_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.octo_free.success": "MiMo Auto (free) is ready — default model set to octo/octo-auto",
  "tui.dialog.login.octo_free.unavailable": "MiMo Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.octo.recommended_hint": "recommended",
  "cli.providers.octo_free.hint": "Anonymous free channel / octo-auto",
  "cli.providers.octo_free.verifying": "Verifying MiMo Auto (free) channel...",
  "cli.providers.octo_free.ready": "MiMo Auto (free) channel ready",
  "cli.providers.octo_free.failed": "MiMo Auto (free) verification failed",
  "cli.providers.octo_free.default_set": "Default model set to octo/octo-auto (1M context, free)",
  "cli.providers.octo_free.usage_hint": "No login required — just run octo. For paid/premium models, choose MiMo browser login instead.",
  "cli.providers.octo_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.octo_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "trust.capabilities": "OctoCode will be able to read, edit, and execute files here.",

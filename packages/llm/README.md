...
Schema-first LLM core for octocode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@octocode-ai/llm"
import { OpenAI } from "@octocode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@octocode-ai/llm/providers"

import type { Config, OctocodeClient, Path, Project, ProviderAuthResponse, Todo } from "@octocode-ai/sdk/v2/client"
...
import { createSimpleContext, NormalizedProviderListResponse } from "@octocode-ai/ui/context"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: OctocodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: OctocodeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => OctocodeClient,
) {
  return {
...
export function createServerSyncContextInner(_serverSDK?: ServerSDK) {
  ...
  const sdkCache = new Map<string, OctocodeClient>()

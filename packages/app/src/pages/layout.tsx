...
import { ResizeHandle } from "@octocode-ai/ui/resize-handle"
import { Button } from "@octocode-ai/ui/button"
import { IconButton } from "@octocode-ai/ui/icon-button"
import { Tooltip } from "@octocode-ai/ui/tooltip"
import { DropdownMenu } from "@octocode-ai/ui/dropdown-menu"
import { Dialog } from "@octocode-ai/ui/dialog"
import { getFilename } from "@octocode-ai/core/util/path"
import { Session, type Message } from "@octocode-ai/sdk/v2/client"
...
import { toaster } from "@octocode-ai/ui/toast"
...
import { retry } from "@octocode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@octocode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://octocode.ai/desktop-feedback")}
      renderPanel={() =>

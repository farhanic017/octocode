...
beforeAll(async () => {
  ...
  mock.module("@octocode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@octocode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@octocode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@octocode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

...
beforeAll(async () => {
  ...
  mock.module("@octo-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@octo-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@octo-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@octo-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

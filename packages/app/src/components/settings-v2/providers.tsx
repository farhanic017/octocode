...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "octo", key: "dialog.provider.octocode.note" },
  { match: (id: string) => id === "octocode-go", key: "dialog.provider.octocodeGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "octo" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "octo" || item.id === "octocode-go"}>

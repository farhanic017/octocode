export const dict = {
  ...
  "dialog.provider.octocode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.octocode.tagline": "Reliable optimized models",
  "dialog.provider.octocodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OctoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OctoCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.octocodeZen.line1":
    "OctoCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.octocodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.octocodeZen.visit.prefix": "Visit ",
  "provider.connect.octocodeZen.visit.link": "octocode.ai/zen",
  "provider.connect.octocodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OctoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OctoCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in octocode.json",
  ...
  "dialog.server.description": "Switch which OctoCode server this app connects to.",
  ...
  "wsl.onboarding.step.octocode": "OctoCode",
  ...
  "wsl.onboarding.checkingOctocode": "Checking OctoCode...",
  "wsl.onboarding.checkingOctocodeIn": "Checking OctoCode in {{distro}}...",
  "wsl.onboarding.updatingOctocode": "Updating OctoCode...",
  "wsl.onboarding.updatingOctocodeIn": "Updating OctoCode in {{distro}}...",
  "wsl.onboarding.updateOctocodeIn": "Update OctoCode in {{distro}}.",
  "wsl.onboarding.updateOctocode": "Update OctoCode",
  "wsl.onboarding.octocodeReadyIn": "OctoCode is ready in {{distro}}.",
  "wsl.onboarding.octocodeReady": "OctoCode is ready.",
  "wsl.onboarding.installOctocodeIn": "Install OctoCode in {{distro}}.",
  "wsl.onboarding.installOctocode": "Install OctoCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OctoCode.",
  ...
  "toast.update.description": "A new version of OctoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OctoCode team",
  ...
  "error.chain.checkConfig": "Check your config (octocode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OctoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OctoCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OctoCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OctoCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OctoCode",
  ...
  "settings.general.row.appearance.description": "Customise how OctoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OctoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OctoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OctoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OctoCode.",

export const dict = {
  ...
  "dialog.provider.octocode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.octocode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.octocodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OctoCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OctoCode.",
  ...
  "provider.connect.octocodeZen.line1":
    "OctoCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.octocodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.octocodeZen.visit.link": "octocode.ai/zen",
  "provider.connect.octocodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OctoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OctoCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w octocode.json",
  ...
  "dialog.server.description": "Przełącz serwer OctoCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OctoCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OctoCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (octocode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OctoCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OctoCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OctoCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OctoCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OctoCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OctoCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OctoCode.",

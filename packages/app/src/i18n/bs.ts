export const dict = {
  ...
  "dialog.provider.octocode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.octocode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.octocodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OctoCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OctoCode-u.",
  ...
  "provider.connect.octocodeZen.line1":
    "OctoCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.octocodeZen.visit.prefix": "Posjeti ",
  "provider.connect.octocodeZen.visit.link": "octocode.ai/zen",
  "provider.connect.octocodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OctoCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OctoCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u octocode.json",
  ...
  "dialog.server.description": "Promijeni na koji se OctoCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OctoCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OctoCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (octocode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OctoCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OctoCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OctoCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OctoCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OctoCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OctoCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OctoCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OctoCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OctoCode-a.",

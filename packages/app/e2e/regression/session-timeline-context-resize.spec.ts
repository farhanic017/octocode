...
import { mockOctoCodeServer } from "../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../utils/waits"

const directory = "C:/OctoCode/ContextResizeRegression"
...
const model = { providerID: "octo", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["octo"],
    default: { providerID: "octo", modelID: "claude-opus-4-6" },
  }
}

...
class Database extends Context.Service<Database, DatabaseShape>()("@octocode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@octocode/example/UserStore") {

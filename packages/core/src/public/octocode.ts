export * as OctoCode from "./octocode"
...
/** Intentional public native API for Effect applications embedding OctoCode. */
export class Service extends Context.Service<Service, Interface>()("@octocode/public/OctoCode") {}
...
>()("@octocode/public/OctoCode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("OctoCode.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("OctoCode.sessions.switchModel")(function* (input) {
...
// TODO: Add OctoCode.create(...) as the Promise facade over the same native API semantics.

...
export class Service extends Context.Service<Service, Interface>()("@octocode/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.OCTOCODE_EXPERIMENTAL_REFERENCES) return Service.of(inert)

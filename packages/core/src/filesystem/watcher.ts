...
declare const OCTOCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OCTOCODE_LIBC === "undefined" ? undefined : OCTOCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@octocode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OCTOCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OCTOCODE_EXPERIMENTAL_FILEWATCHER) {

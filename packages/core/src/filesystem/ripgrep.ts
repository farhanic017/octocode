...
import { sanitizedProcessEnv } from "../util/octocode-process"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".octocode")) continue

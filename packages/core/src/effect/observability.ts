...
import { ensureProcessMetadata } from "../util/octocode-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "octocode.client": Flag.OCTOCODE_CLIENT,
      "octocode.process_role": processMetadata.processRole,
      "octocode.run_id": processMetadata.runID,

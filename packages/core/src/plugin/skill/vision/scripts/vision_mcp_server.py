    ...
    "analyze_image": {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "model": {"type": "string", "description": "Optional model name, e.g. 'mimo-v2.5', 'ollama/llava:latest', 'openrouter/google/gemini-2.5-flash', 'openai/gpt-4o-mini', 'anthropic/claude-sonnet-4-5', or 'cohere/command-a-vision-07-2025'"},
            },
            "required": ["path"],
        },
    },

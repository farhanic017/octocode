...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolSettlement } from "@octocode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/v2/ToolRegistry") {}

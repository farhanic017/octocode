import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@octocode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"

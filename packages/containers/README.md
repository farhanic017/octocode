...
```
REGISTRY=ghcr.io/farhanic017 TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/farhanic017 TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/farhanic017/build/bun-node:24.04
```

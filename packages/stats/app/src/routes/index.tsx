...
const statsHomeTitle = "OctoCode Stats"
const statsHomeDescription = "OctoCode usage, market share, token cost, and session cost stats."
const statsHomeFallbackUrl = "https://octocode.ai/stats/"
const statsUnfurlPath = "banner.png"
const statsUnfurlAlt = "OctoCode Stats wordmark on a dark patterned background"
const usageColors = [
  "#ed6aff",
  "#a684ff",
  "#7c86ff",
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.octocode.ai") return "https://octocode.ai/stats/"
  if (url.hostname === "stats.dev.octocode.ai") return "https://dev.octocode.ai/stats/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across OctoCode Go.</span>
      </h2>
      <Show

import octocodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/farhanic017/octocode",
  apiHref: "https://api.github.com/repos/farhanic017/octocode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star OctoCode on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "octocode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://octocode.ai/">
            <strong>Try OctoCode</strong>
          </a>
          <button
...
function OctoCodeMark() {
  return (
    <svg data-slot="octocode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://octocode.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://octocode.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@octocode.ai", label: "Contact us" },
    { href: "https://octocode.ai/discord", label: "Community" },
    { href: "https://x.com/octocode", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://octocode.ai" aria-label="OctoCode home">
          <OctoCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={octocodeWordmarkDark} alt="OctoCode" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">OctoCode Newsletter</h2>
            <p>

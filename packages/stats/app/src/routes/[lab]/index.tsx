...
const statsLabFallbackUrl = "https://stats.octocode.ai"
...
export default function StatsLab() {
  ...
  const labDescription = createMemo(
    () =>
      `Explore ${labName()} models used in OctoCode, with recent token usage, context windows, release dates, and model-specific stats.`,
  )
    ...
    <section id="overview" data-section="lab-hero">
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <h1>Model Lab</h1>
          <p>Reading model availability and recent OctoCode usage.</p>
        </div>
      </div>
    </section>
  )
    ...
    <section id="overview" data-section="lab-hero">
      ...
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <p>
            Explore {props.lab.models.length} {props.lab.name} models used in OctoCode
        ...
        <div data-component="model-rank-panel">
          ...
          <p>
            {props.stats
              ? `${formatPercent(props.stats.tokenShare)} of recent OctoCode usage`
              : latest()
  ...
  return (
    <section id="usage" data-section="model-panel">
      <p data-slot="section-title">
        ...
        <span>Daily OctoCode token volume over the last two months.</span>
      </p>
      <Show

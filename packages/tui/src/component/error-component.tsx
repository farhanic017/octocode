...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/farhanic017/octocode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("octocode-version", InstallationVersion)

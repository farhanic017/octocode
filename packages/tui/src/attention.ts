...
import defaultSoundPath from "@octocode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@octocode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@octocode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@octocode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@octocode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@octocode-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "octo code"
const DEFAULT_PACK_ID = "octocode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "octo code Default",
  builtin: true,
  sounds: {

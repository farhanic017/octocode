...
import type { TuiPlugin, TuiPluginApi, TuiRouteCurrent } from "@octocode-ai/plugin/tui"
...
const PLAIN_TEXT_FILETYPE = "octocode-plain-text"
...
function DiffViewer(props: { api: TuiPluginApi }) {
  ...
  const jumpRelativeHunk = (offset: -1 | 1) => {
    ...
    if (!patchScroll || patchScroll.isDestroyed) return

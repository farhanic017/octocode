...
import { aggregateFailures } from "@octocode-ai/tui/context/aggregate-failures"
...
describe("aggregateFailures", () => {
  ...
  test("formats structured config errors hidden inside SDK error causes", () => {
    ...
    expect(err!.message).toContain("config.get: Configuration is invalid at /tmp/octocode.json")

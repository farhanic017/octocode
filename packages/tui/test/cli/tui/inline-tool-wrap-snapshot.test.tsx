...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OCTOCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/octocode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/octocode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/octocode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/octocode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OCTOCODE_DB|OCTOCODE_DB|OCTOCODE_DEV|Global\\.Path\\.data|data =" in packages/octocode/src (115 matches)',
  },
] as const

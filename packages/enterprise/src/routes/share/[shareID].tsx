import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@octocode-ai/sdk/v2"
import { SessionTurn } from "@octocode-ai/ui/session-turn"
import { SessionReview } from "@octocode-ai/ui/session-review"
import { DataProvider } from "@octocode-ai/ui/context"
import { FileComponentProvider } from "@octocode-ai/ui/context/file"
import { WorkerPoolProvider } from "@octocode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@octocode-ai/ui/logo"
import { IconButton } from "@octocode-ai/ui/icon-button"
import { ProviderIcon } from "@octocode-ai/ui/provider-icon"
import { iife } from "@octocode-ai/core/util/iife"
import { Binary } from "@octocode-ai/core/util/binary"
import { NamedError } from "@octocode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@octocode-ai/ui/tabs"
import { MessageNav } from "@octocode-ai/ui/message-nav"
import { FileSSR } from "@octocode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@octocode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/octocode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OctoCode</Title>
              </Show>
              <Meta name="description" content="octocode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/octocode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://octocode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />

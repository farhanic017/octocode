...
declare const OCTOCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OCTOCODE_CLI_NAME === "string" ? OCTOCODE_CLI_NAME : "octo", {
  description: "OctoCode 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {

...
export const RootHttpApi = HttpApi.make("octocode-root")
...
export const InstanceHttpApi = HttpApi.make("octocode-instance")
...
export const OctoCodeHttpApi = HttpApi.make("octo")

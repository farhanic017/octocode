...
import { OctoCodeHttpApi } from "./api"
...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for octo serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(OctoCodeHttpApi)
...
export const PublicApi = OctoCodeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "octo code",
    version: "1.0.0",
    description: "octo code api",

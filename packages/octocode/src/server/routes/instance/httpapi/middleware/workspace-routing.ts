...
>()("@octocode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@octocode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OCTOCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OCTOCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-octocode-directory"] || process.cwd()
}

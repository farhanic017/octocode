...
import type { OctocodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@octocode-ai/sdk/v2"
import type { TuiConfig } from "@octocode-ai/tui/config"
...
type PromptModel = Parameters<OctocodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<OctocodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<OctocodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<OctocodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<OctocodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<OctocodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<OctocodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<OctocodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<OctocodeClient["question"]["reject"]>[0]

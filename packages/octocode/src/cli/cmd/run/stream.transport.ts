...
import type { Event, GlobalEvent, OctocodeClient } from "@octocode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@octocode/RunStreamTransport") {}

...
//
// The saved variant persists across sessions in ~/.local/state/octocode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@octocode/RunVariant") {}

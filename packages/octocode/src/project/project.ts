...
import { ProjectDirectoryTable, ProjectTable } from "@octocode-ai/core/project/sql"
...
import { which } from "@octocode-ai/core/util/which"
...
import { ProjectCopy } from "@octocode-ai/core/project/copy"
import { CrossSpawnSpawner } from "@octocode-ai/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@octocode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.OCTOCODE_FAKE_VCS)

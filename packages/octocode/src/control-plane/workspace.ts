...
import { EventSequenceTable, EventTable } from "@octocode-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OCTOCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OCTOCODE_WORKSPACE_ID: config.id,
        OCTOCODE_EXPERIMENTAL_WORKSPACES: "true",

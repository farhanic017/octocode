...
import { AccountStateTable, AccountTable } from "@octocode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/AccountRepo") {}

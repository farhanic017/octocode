import type { JsonSchema, LLMRequest, ProviderMetadata } from "@octocode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@octocode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @octocode-ai/llm request objects from octocode's session/AI SDK-shaped data.
  return LLM.request({

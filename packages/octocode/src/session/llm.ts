...
import type { LLMEvent } from "@octocode-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@octocode-ai/llm/route"
import type { LLMClientService } from "@octocode-ai/llm/route"
...
export const OUTPUT_TOKEN_MAX = ProviderTransform.DEFAULT_OUTPUT_TOKEN_MAX
...
export class Service extends Context.Service<Service, Interface>()("@octocode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via octocode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @octocode-ai/llm. It

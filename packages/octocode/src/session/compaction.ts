...
import { buildPrompt } from "@octocode-ai/core/session/compaction"
...
function preserveRecentBudget(input: { cfg: ConfigV1.Info; model: Provider.Model }) {
  return (
    ...
    Math.min(MAX_PRESERVE_RECENT_TOKENS, Math.max(MIN_PRESERVE_RECENT_TOKENS, Math.floor(usable(input) * 0.15)))
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@octocode/SessionCompaction") {}

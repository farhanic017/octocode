...
import type { AssistantMessage as OctoAssistantMessage, Message } from "@octocode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<OctoAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OctoAssistantMessage, "role"> &
  Partial<Pick<OctoAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@octocode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@octocode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@octocode/ACPUsage") {}

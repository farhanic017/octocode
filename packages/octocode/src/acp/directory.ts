...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@octocode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@octocode/ACPDirectory") {}

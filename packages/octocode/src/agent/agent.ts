...
export class Service extends Context.Service<Service, Interface>()("@octocode/Agent") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          "agent-swarm": {
            name: "agent-swarm",
            description: "Runs the Agent Swarm multi-agent orchestrator with council voting, parallel agents, and continuous learning.",
            options: {},
            permission: Permission.merge(
              defaults,
              Permission.fromConfig({

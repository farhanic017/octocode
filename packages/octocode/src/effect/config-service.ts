 ...
 *   "@octocode/ServerAuthConfig",
 *   {
 *     password: Config.string("OCTOCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OCTOCODE_SERVER_USERNAME").pipe(Config.withDefault("octo")),
 *   },
 * ) {}
 *

...
import { createBuiltinPlugins, type BuiltinTuiPlugin } from "@octocode-ai/tui/builtins"
...
export function internalTuiPlugins(flags: Pick<RuntimeFlags.Info, "experimentalEventSystem">): InternalTuiPlugin[] {
  return createBuiltinPlugins({
    ...
    experimentalSessionSwitcher: Flag.OCTOCODE_EXPERIMENTAL_SESSION_SWITCHER,
  })
}

...
<html>
  <head>
    <title>octo code - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>octo code - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "octo"
      output.headers["User-Agent"] = `octocode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`

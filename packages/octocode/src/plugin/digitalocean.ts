import type { Hooks, PluginInput } from "@octocode-ai/plugin"
import type { Model } from "@octocode-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>octo code - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to octo code."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. octo code will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",

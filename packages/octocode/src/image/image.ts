...
export class Service extends Context.Service<Service, Interface>()("@octocode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OCTOCODE_PHOTON_WASM_PATH?: string }).__OCTOCODE_PHOTON_WASM_PATH =

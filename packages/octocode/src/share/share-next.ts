import type * as SDK from "@octocode-ai/sdk/v2"
...
import { SessionShareTable } from "@octocode-ai/core/share/sql"
...
const disabled = process.env["OCTOCODE_DISABLE_SHARE"] === "true" || process.env["OCTOCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@octocode/ShareNext") {}

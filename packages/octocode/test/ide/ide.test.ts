...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OCTOCODE_CALLER", () => {
    process.env["OCTOCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OCTOCODE_CALLER", () => {
    process.env["OCTOCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OCTOCODE_CALLER", () => {
    process.env["OCTOCODE_CALLER"] = "unknown"

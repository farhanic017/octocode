  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "octocode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "octocode-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "octocode-glob-reference/repo",
        },
      },
    },
  )

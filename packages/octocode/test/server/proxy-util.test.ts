...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips octocode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-octocode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-octocode-directory")).toBeNull()
      expect(result.get("x-octocode-workspace")).toBeNull()

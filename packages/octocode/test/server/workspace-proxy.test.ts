...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips octocode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-octocode-directory"]).toBeUndefined()
      expect(forwarded["x-octocode-workspace"]).toBeUndefined()

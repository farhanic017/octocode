...
Practical reference for the current tool-migration state in `packages/octocode`.
...
Tool tests should use the existing Effect helpers in `packages/octocode/test/lib/effect.ts`:

...
import { and, Database, eq, isNull, lt, or, sql } from "@octocode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@octocode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@octocode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@octocode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@octocode-ai/console-core/util/date.js"
import { Identifier } from "@octocode-ai/console-core/identifier.js"
import { Billing } from "@octocode-ai/console-core/billing.js"
import { Actor } from "@octocode-ai/console-core/actor.js"
import { WorkspaceTable } from "@octocode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@octocode-ai/console-core/model.js"
import { Subscription } from "@octocode-ai/console-core/subscription.js"
import { BlackData } from "@octocode-ai/console-core/black.js"
import { UserTable } from "@octocode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@octocode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@octocode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@octocode-ai/console-core/lite.js"
import { Resource } from "@octocode-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-octocode-session") ?? ""
    const requestId = input.request.headers.get("x-octocode-request") ?? ""
    const ocClient = input.request.headers.get("x-octocode-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-octocode-request")
          headers.delete("x-octocode-session")
          headers.delete("x-octocode-project")
          headers.delete("x-octocode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://octocode.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://octocode.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://octocode.ai/workspace/${authInfo.workspaceID}/members`

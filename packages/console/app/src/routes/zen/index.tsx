...
import compareVideo from "../../asset/lander/octocode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/octocode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="octocode:auth" content={loggedin() ? "true" : "false"} />

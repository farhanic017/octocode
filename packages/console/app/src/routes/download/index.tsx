...
import desktopAppIcon from "../../asset/lander/octocode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://octocode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>octocode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g octocode-ai")}>
                <code>
                  npm i -g <strong>octocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g octocode-ai")}>
                <code>
                  bun add -g <strong>octocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install farhanic017/tap/octocode")}>
                <code>
                  brew install <strong>farhanic017/tap/octocode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S octocode")}>
                <code>
                  paru -S <strong>octocode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask octocode-desktop")}>
                <code>
                  brew install --cask <strong>octocode-desktop</strong>
                </code>
                <CopyStatus />
              </button>

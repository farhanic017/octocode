...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-octocode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeOctocode(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-octocode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installOctocode(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-octocode", unavailable)
  ipcMain.handle("wsl-servers-install-octocode", unavailable)

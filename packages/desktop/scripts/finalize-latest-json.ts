...
const releaseId = process.env.OCTOCODE_RELEASE
if (!releaseId) throw new Error("OCTOCODE_RELEASE is required")

const version = process.env.OCTOCODE_VERSION
if (!version) throw new Error("OCTOCODE_VERSION is required")
...
const macxTarGz = "octocode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "octocode-desktop-mac-arm64.app.tar.gz"

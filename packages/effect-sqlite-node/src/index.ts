...
export const TypeId: TypeId = "~@octocode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@octocode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@octocode-ai/effect-sqlite-node/NodeSqliteClient")

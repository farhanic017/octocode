...
import { IconOctocode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "octocode/session/message-v2"
import type { Message } from "octocode/session/message"
import type { Session } from "octocode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.octocode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.octocode_name}>
                    <IconOctocode width={16} height={16} />
                  </div>

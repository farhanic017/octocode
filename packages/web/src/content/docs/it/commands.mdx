...
Crea `.octocode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OctoCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OctoCode:
...
- Globale: `~/.config/octocode/commands/`
- Per progetto: `.octocode/commands/`
...
octocode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

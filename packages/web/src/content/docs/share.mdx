---
title: Share
description: Share your OctoCode conversations.
---

OctoCode's share feature allows you to create public links to your OctoCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OctoCode:
...
OctoCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OctoCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `octocode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using octocode in your organization.

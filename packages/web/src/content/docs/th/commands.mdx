...
สร้าง `.octocode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OctoCode:
...
- ระดับผู้ใช้ (Global): `~/.config/octocode/commands/`
- ระดับโปรเจ็กต์: `.octocode/commands/`
...
OctoCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

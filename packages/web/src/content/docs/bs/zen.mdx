---
title: Zen
description: Kurirana lista modela koje nudi OctoCode.
---
...
OctoCode Zen je lista testiranih i provjerenih modela koje pruža OctoCode tim.

Zen radi kao i svaki drugi provajder u OctoCode. Prijavite se na OctoCode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili OctoCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s OctoCode.
:::
...
OctoCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

OctoCode Zen radi kao i svaki drugi provajder u OctoCode.

1. Prijavite se na **<a href={console}>OctoCode Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite OctoCode Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj OctoCode konfiguraciji koristi format
`octocode/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `octocode/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na OctoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na OctoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na OctoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na OctoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u OctoCode.

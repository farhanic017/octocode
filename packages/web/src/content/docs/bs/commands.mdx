...
Kreiraj `.octocode/commands/test.md`:
...
Možete dodati prilagođene komande kroz OctoCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OctoCode [config](/docs/config):
...
- Globalno: `~/.config/octocode/commands/`
- Po projektu: `.octocode/commands/`
...
OctoCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

...
Agent skills omogucavaju OctoCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
OctoCode pretrazuje ove lokacije:

- Konfiguracija projekta: `.octocode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/octocode/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, OctoCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.octocode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/octocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.octocode/skills/git-release/SKILL.md` ovako:
...
OctoCode navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `octocode.json`:
...
**Za ugradene agente** (u `octocode.json`):

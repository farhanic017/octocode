---
title: TUI
description: Korištenje korisničkog interfejsa OctoCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OctoCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OctoCode pokreće TUI za trenutni direktorij.
...
Kada koristite OctoCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OctoCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OctoCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `octocode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OctoCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `octocode.default`.

...
Erstellen Sie `.octocode/commands/test.md`:

```md title=".octocode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OctoCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OctoCode [config](/docs/config):

```json title="octocode.jsonc" {4-12}
{
...
- Global: `~/.config/octocode/commands/`
- Pro Projekt: `.octocode/commands/`

```markdown title="~/.config/octocode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".octocode/commands/component.md"
---
...
```md title=".octocode/commands/create-file.md"
---
...
```md title=".octocode/commands/analyze-coverage.md"
---
...
```md title=".octocode/commands/review-changes.md"
---
...
```md title=".octocode/commands/review-component.md"
---
...
OctoCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

---
title: SDK
description: Typsicherer JS-Client fuer den octocode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das octocode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und octocode programmatisch steuern.
...
Erstelle eine octocode-Instanz:
...
`octocode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn octocode bereits laeuft, kannst du nur einen Client erstellen und verbinden:

---
title: Teilen
description: Teile OctoCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OctoCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OctoCode Folgendes:
...
OctoCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OctoCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`octocode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du octocode in deiner Organisation einsetzt.

...
Crear `.octocode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OctoCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OctoCode [config](/docs/config):
...
- Por proyecto: `.octocode/commands/`
...
octocode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala octocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

octocode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie octocode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI octocode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do octocode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij octocode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `octocode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OctoCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `octocode.default`.

---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OctoCode.
---
...
OctoCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OctoCode.

Zen działa jak każdy inny dostawca w OctoCode. Logujesz się do OctoCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OctoCode.
:::
...
OctoCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OctoCode Zen działa jak każdy inny dostawca w OctoCode.

1. Logujesz się do **<a href={console}>OctoCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OctoCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OctoCode używa formatu
`octocode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`octocode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w OctoCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w OctoCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w OctoCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OctoCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OctoCode także dowolnego innego dostawcy.

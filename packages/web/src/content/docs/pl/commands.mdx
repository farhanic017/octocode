...
Utwórz `.octocode/commands/test.md`:
...
Możesz zdefiniować polecenia w `octocode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji octocode:
...
- Globalnie: `~/.config/octocode/commands/`
- Na projekt: `.octocode/commands/`
...
octocode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

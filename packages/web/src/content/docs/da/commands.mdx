...
Opret `.octocode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem OctoCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OctoCode [config](/docs/config):
...
- Globalt: `~/.config/octocode/commands/`
- Pr. projekt: `.octocode/commands/`
...
octocode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

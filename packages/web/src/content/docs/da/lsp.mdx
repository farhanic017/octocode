---
title: LSP-servere
description: OctoCode integreres med dine LSP-servere.
---

OctoCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OctoCode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OCTOCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og octocode åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din octocode-konfiguration.

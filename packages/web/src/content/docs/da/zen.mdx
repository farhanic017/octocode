---
title: Zen
description: Udvalgt liste over modeller leveret af OctoCode.
---
...
OctoCode Zen er en liste over testede og verificerede modeller leveret af OctoCode-teamet.

Zen fungerer som enhver anden udbyder i OctoCode. Du logger ind på OctoCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med OctoCode.
:::
...
OctoCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OctoCode Zen fungerer som enhver anden udbyder i OctoCode.

1. Du logger ind på **<a href={console}>OctoCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger OctoCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din OctoCode-konfiguration
bruger formatet `octocode/<model-id>`. For eksempel ville du for GPT 5.5
bruge `octocode/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på OctoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på OctoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på OctoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på OctoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med OctoCode også.

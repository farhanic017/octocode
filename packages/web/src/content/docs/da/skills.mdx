...
Agentferdigheter lar OctoCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
OctoCode søker etter disse stedene:

- Prosjektkonfigurasjon: `.octocode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/octocode/skills/<name>/SKILL.md`
...
For prosjektlokale stier går OctoCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.octocode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/octocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.octocode/skills/git-release/SKILL.md` slik:
...
OctoCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `octocode.json`:
...
**For innebygde agenter** (i `octocode.json`):

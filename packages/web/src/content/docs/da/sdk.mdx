...
Brug den til at bygge integrasjoner og kontrollere octocode programmatisk.
...
Opret en forekomst av octocode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `octocode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av octocode, kan du oprete en klientforekomst for at koble til den:

---
title: TUI
description: Brug af OctoCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OctoCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OctoCode starter TUI for den nuværende mappe.
...
Når du bruger OctoCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OctoCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OctoCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `octocode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe OctoCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `octocode.default`.

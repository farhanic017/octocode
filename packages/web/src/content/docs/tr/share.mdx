---
title: Paylasim
description: octocode konusmalarini genel baglantilarla paylasin.
---

octocode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda octocode:
...
octocode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak octocode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `octocode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda octocode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

...
`.octocode/commands/test.md` oluştur:
...
octocode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

octocode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/octocode/commands/`
- Proje başına: `.octocode/commands/`
...
octocode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

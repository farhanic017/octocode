...
Ajan becerileri, octocode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
octocode su konumlari tarar:

- Proje konfigurasyonu: `.octocode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/octocode/skills/<name>/SKILL.md`
...
Proje yerel yollarinda octocode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.octocode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/octocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.octocode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
octocode, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`octocode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`octocode.json` icinde):

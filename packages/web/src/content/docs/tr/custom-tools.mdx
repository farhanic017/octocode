---
title: Özel Araçlar
description: LLM'un octocode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. octocode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.octocode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/octocode/tools/` içine yerleştirerek.

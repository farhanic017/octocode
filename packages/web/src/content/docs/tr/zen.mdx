---
title: Zen
description: octocode tarafından sağlanan seçilmiş modeller listesi.
---
...
OctoCode Zen, OctoCode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, OctoCode'daki diğer sağlayıcılar gibi çalışır. OctoCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve OctoCode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
OctoCode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OctoCode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

OctoCode Zen, OctoCode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>OctoCode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, OctoCode Zen'i seçin ve API anahtarınızı yapıştırın.
...
OctoCode yapılandırmanızdaki [model id](/docs/config/#models) `octocode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `octocode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için OctoCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için OctoCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için OctoCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için OctoCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
OctoCode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca OctoCode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.

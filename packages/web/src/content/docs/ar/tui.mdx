---
title: TUI
description: استخدام واجهة المستخدم TUI في OctoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OctoCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OctoCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OctoCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OctoCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OctoCode. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `octocode.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار OctoCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `octocode.default`.

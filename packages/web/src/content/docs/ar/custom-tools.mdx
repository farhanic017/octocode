...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في octocode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في octocode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.octocode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/octocode/tools/`.

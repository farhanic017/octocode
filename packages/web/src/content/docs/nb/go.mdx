...
OctoCode Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i OctoCode. Du abonnerer på OctoCode Go og
...
OctoCode Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

OctoCode Go fungerer som enhver annen leverandør i OctoCode.

1. Du logger inn på **<a href={console}>OctoCode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `OctoCode Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på OctoCode Go.
:::
...
OctoCode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din OctoCode-konfigurasjon
bruker formatet `octocode-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `octocode-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet OctoCode Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med OctoCode også.

---
title: Zen
description: Utvalgt liste over modeller levert av OctoCode.
---
...
OctoCode Zen er en liste over testede og verifiserte modeller levert av OctoCode-teamet.

Zen fungerer som enhver annen leverandør i OctoCode. Du logger inn på OctoCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OctoCode.
:::
...
OctoCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OctoCode Zen fungerer som enhver annen leverandør i OctoCode.

1. Du logger inn på **<a href={console}>OctoCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger OctoCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i OctoCode-konfigurasjonen din
bruker formatet `octocode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `octocode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på OctoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på OctoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på OctoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OctoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet OctoCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med OctoCode også.

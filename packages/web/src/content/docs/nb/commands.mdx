...
Opprett `.octocode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OctoCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OctoCode [config](/docs/config):
...
- Per prosjekt: `.octocode/commands/`
...
OctoCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

---
title: TUI
description: Bruke octocode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OctoCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OctoCode starter TUI for gjeldende katalog.
...
Når du bruker OctoCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OctoCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OctoCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `octocode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge OctoCode venter etter leader key. Standard er `2000`.
...
Bruk `OCTOCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `octocode.default`.

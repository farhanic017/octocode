...
Agentferdigheter lar OctoCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går octocode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
octocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `octocode.json`:

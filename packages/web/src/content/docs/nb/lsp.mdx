---
title: LSP-servere
description: octocode integreres med LSP-serverne dine.
---

OctoCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OctoCode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OCTOCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og octocode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OctoCode-konfigurasjonen.

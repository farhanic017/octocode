...
npm i -g octocode-ai@latest        # o bun/pnpm/yarn
scoop install octocode             # Windows
choco install octocode             # Windows
brew install farhanic017/tap/octocode # macOS y Linux (recomendado, siempre al día)
brew install octocode              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S octocode            # Arch Linux (Stable)
paru -S octocode-bin               # Arch Linux (Latest from AUR)
mise use -g octocode               # cualquier sistema
nix run nixpkgs#octocode           # o github:farhanic017/octocode para la rama dev más reciente
```
...
OctoCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/farhanic017/octocode/releases) o desde [octocode.ai/download](https://octocode.ai/download).
...
1. `$OCTOCODE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.octocode/bin` - Alternativa por defecto
...
OctoCode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://octocode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar OctoCode, [**ve a nuestra documentación**](https://octocode.ai/docs).

### Contribuir

Si te interesa contribuir a OctoCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en OctoCode

Si estás trabajando en un proyecto basado en OctoCode y usas "octo" como parte del nombre, por ejemplo, "octocode-dashboard" u "octocode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de OctoCode y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/octocode) | [X.com](https://x.com/octocode)

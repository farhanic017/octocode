#!/usr/bin/env node
/**
 * rename-octocode-to-octocode-phase7.mjs
 * 
 * Phase 7: Final comprehensive rename of all remaining octocode references.
 * Handles translation keys, function names, and other specific contexts.
 */
...
// Phase 7: Comprehensive rename
const RENAMES = [
  // Translation keys
  { from: 'updateOctocodeIn', to: 'updateOctocodeIn' },
  { from: 'updateOctocode', to: 'updateOctocode' },
  { from: 'openOctocodeStep', to: 'openOctocodeStep' },
  
  // Function names
  { from: 'openOctocode', to: 'openOctocode' },
  { from: 'closeOctocode', to: 'closeOctocode' },
...
console.log(`Starting Phase 7 rename: octocode -> octocode`);

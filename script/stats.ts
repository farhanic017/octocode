...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/farhanic017/octocode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for farhanic017/octocode...\n")
...
console.log("Fetching npm all-time downloads for octocode-ai...\n")
const npmDownloads = await fetchNpmDownloads("octocode-ai")

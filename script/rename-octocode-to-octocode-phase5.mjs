#!/usr/bin/env node
/**
 * rename-octocode-to-octocode-phase5.mjs
 * 
 * Phase 5: Final comprehensive rename of all remaining octocode references.
 * Handles variable names, translation keys, and other specific contexts.
 */
...
// Phase 5: Comprehensive rename
const RENAMES = [
  // WSL variables
  { from: 'installingOctocode', to: 'installingOctocode' },
  { from: 'checkingOctocode', to: 'checkingOctocode' },
  { from: 'updatingOctocode', to: 'updatingOctocode' },
...
console.log(`Starting Phase 5 rename: octocode -> octocode`);

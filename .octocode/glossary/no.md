...
- PR #10018: https://github.com/anomalyco/octocode/pull/10018
- PR #12935: https://github.com/anomalyco/octocode/pull/12935

## Do Not Translate (Locale Additions)

- `OctoCode` (preserve casing in prose; keep `octo` only in commands, package names, paths, or code)
- `OctoCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

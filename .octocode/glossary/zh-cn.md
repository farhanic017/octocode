...
- PR #13942: https://github.com/anomalyco/octocode/pull/13942

## Do Not Translate (Locale Additions)

- `OctoCode` (preserve casing in prose; keep `octo` only when it is part of commands, package names, paths, or code)
- `OctoCode Zen`
- `OctoCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `octo` in prose when referring to the product name; use `OctoCode`

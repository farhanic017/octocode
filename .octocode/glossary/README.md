...
Use this folder for locale-specific translation guidance that supplements `.octocode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/octocode/pull/12345

## Do Not Translate (Locale Additions)

- `OctoCode` (preserve casing)

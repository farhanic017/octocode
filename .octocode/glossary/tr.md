...
- PR #15835: https://github.com/anomalyco/octocode/pull/15835

## Do Not Translate (Locale Additions)

- `OctoCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `octo` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OctoCode` in prose, `octo` only for exact technical identifiers
...
- Avoid changing `octo` to `OctoCode` inside commands, URLs, package names, or code literals
